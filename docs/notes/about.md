...
# :material-book-open-page-variant-outline: About

Information, compiled for easy reference. This section has longer form write-ups, guides, research, and more. Navigate over to the [resources](../resources.md) tab if you're just looking for external references in general.
